...
export async function PATCH(request, { params }) {
  try {
    ...
    // PRIORIDADE: Se status vier explicitamente, usar ele
    ...
    // MUDAR STATUS PARA SOLD AUTOMATICAMENTE ao registrar venda
    // MAS APENAS SE STATUS NÃO FOI DEFINIDO EXPLICITAMENTE
    if ((body.soldValue !== undefined || body.customer !== undefined || body.serialNumber !== undefined) 
